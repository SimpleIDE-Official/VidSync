...
android {
    namespace = "com.itsvks.vidsync"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.itsvks.vidsync"
        minSdk = 24
        targetSdk = 35
        versionCode = 1
        versionName = "1.1"
...
dependencies {
    ...
    implementation(libs.ytdl.library)
    implementation(libs.ytdl.ffmpeg)
    implementation(libs.ytdl.aria2c) // optional
